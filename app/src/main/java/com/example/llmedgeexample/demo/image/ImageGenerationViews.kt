    ...
    companion object {
        fun bind(activity: Activity): ImageGenerationViews =
            ImageGenerationViews(
                ...
                upscaleButton = activity.findViewById(R.id.btnUpscaleImage),
                saveImageButton = activity.findViewById(R.id.btnSaveImage),
                ...
                hyperSd3Toggle = activity.findViewById(R.id.hyperSd3Toggle),
                easyCacheToggle = activity.findViewById(R.id.imageEasyCacheToggle),
                modelPresetGroup = activity.findViewById(R.id.modelPresetGroup),
                selectModelButton = activity.findViewById(R.id.btnSelectImageModel),
                modelLabel = activity.findViewById(R.id.imageModelLabel),
                clearModelButton = activity.findViewById(R.id.btnClearImageModel),
